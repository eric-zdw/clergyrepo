...
PlayerObject::PlayerObject() : GameObject("sprPlayer.png"), lives(5), invincible(false), hitCircleSize(20) {
	SetTag("Player");
}
PlayerObject::PlayerObject(double x, double y) : GameObject("sprPlayer.png", x, y, PLAYER_WIDTH, PLAYER_HEIGHT), lives(5), invincible(false), hitCircleSize(20) {
	SetTag("Player");
}
